...
# i.e. Perl QXDMSetQShrink4ServerPathExample.pl <Port Number>
...
sub ParseArguments
{
   # Assume failure
   my $RC = false;
   my $Help = "Syntax: Perl QXDMSetQShrink4ServerPathExample.pl <COM Port Number>\n"
            . "Eg:     Perl QXDMSetQShrink4ServerPathExample.pl 5\n";
...
sub Execute
{
   ...
   $QXDM->SetQShrink4ServerPath("\\\\harv-vivekj\\QXDM");   
